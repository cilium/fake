...
// FlowOption is an option to use with Flow.
...
func WithFlowTime(t time.Time) FlowOption {
...
func WithFlowVerdict(v flowpb.Verdict) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.verdict = v
	})
}
...
func WithFlowDropReason(r flowpb.DropReason) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.dropReason = r
	})
}
...
func WithFlowNodeName(name string) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.nodeName = name
	})
}
...
func WithFlowEthernet(e *flowpb.Ethernet) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.ethernet = e
	})
}
...
func WithFlowIP(ip *flowpb.IP) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.ip = ip
	})
}
...
func WithFlowL4(l4 *flowpb.Layer4) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.l4 = l4
	})
}
...
func WithFlowEndpoints(src, dst *flowpb.Endpoint) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.epSource = src
		o.epDest = dst
	})
...
func WithFlowType(t flowpb.FlowType) FlowOption {
	return funcFlowOption(func(o *flowOptions) {
		o.typ = t
	})
}

// Flow generates a random flow. Options may be provided to customize the flow.
func Flow(options ...FlowOption) *flowpb.Flow {
	opts := flowOptions{
		time:     time.Now().UTC(),
		verdict:  Verdict(),
	...
	if opts.typ == flowpb.FlowType_L3_L4 {
		if opts.ip == nil {
			opts.ip = &flowpb.IP{
				Source:      IP(WithIPCIDR("10.0.0.0/8")),
				Destination: IP(WithIPCIDR("10.0.0.0/8")),
